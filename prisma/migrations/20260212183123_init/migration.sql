...
-- CreateIndex
CREATE UNIQUE INDEX "WorkspaceInvitation_workspaceId_inviteeEmail_key" ON "WorkspaceInvitation"("workspaceId", "inviteeEmail");
...
-- AddForeignKey
ALTER TABLE "WorkspaceInvitation" ADD CONSTRAINT "WorkspaceInvitation_inviteeId_fkey" FOREIGN KEY ("inviteeId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "TaskLabel" ADD CONSTRAINT "TaskLabel_labelId_fkey" FOREIGN KEY ("labelId") REFERENCES "BoardLabel"("id") ON DELETE CASCADE ON UPDATE CASCADE;
