...
import { getBoard, updateBoard, deleteBoard } from '@/actions/board-actions';
...
interface BoardMenuProps {
  ...
  userRole?: 'owner' | 'admin' | 'member' | 'readonly';
}

type LabelColor = 'green' | 'yellow' | 'orange' | 'red' | 'purple' | 'blue' | 'sky' | 'lime' | 'pink' | 'gray';

export function BoardMenu({ boardId, currentUserId, userRole = 'member' }: BoardMenuProps) {
  ...
  if (process.env.NODE_ENV === 'development') {
    console.log('🔧 [BoardMenu] boardId reçu:', boardId, 'userRole:', userRole);
  }
      ...
      >
        <div className="space-y-4">
          <p className="text-gray-600">
            Êtes-vous sûr de vouloir supprimer ce board ? Cette action est irréversible et supprimera toutes les listes et cartes associées.
          </p>
          <div className="flex gap-2 justify-end">
            <Button
              variant="outline"
